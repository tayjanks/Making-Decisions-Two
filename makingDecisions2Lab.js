...
else [someNum = myFavoriteNumbers[6], console.log(someNum)];
////////// PROBLEM 8 //////////
...
for (let i=0; i < listOfNumbers.length; i++){if (listOfNumbers[i] % 3 === 0) {console.log (`${listOfNumbers[i]} is divisible by 3`)}}
